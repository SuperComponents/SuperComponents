      ...
      tools: [
        {
          name: 'init_project',
          description:
            'Initialize a new design system project with React, Storybook, TypeScript, and Tailwind v4',
          inputSchema: {
            type: 'object',
            properties: {
              projectName: {
        ...
        },
        {
          ...
          description:
            'Extract design tokens from a URL, image, or description',
          inputSchema: {
            type: 'object',
            properties: {
              source: {
                type: 'string',
                description:
                  'URL, image path, or text description to extract tokens from',
              },
              sourceType: {
                type: 'string',
                enum: ['url', 'image', 'text'],
        ...
        },
        {
          ...
          description:
            'Generate a style showcase page displaying all design tokens',
          inputSchema: {
            type: 'object',
            properties: {
              outputPath: {
        ...
        },
        {
          ...
          description:
            'Guide the user in establishing north-star design principles',
          inputSchema: {
            type: 'object',
            properties: {},
          },
        },
        {
          ...
          description:
            'Analyze design principles and suggest a component library structure',
          inputSchema: {
            type: 'object',
            properties: {
              principles: {
        ...
        },
        {
          ...
          description:
            'Generate a detailed implementation prompt for a specific component',
          inputSchema: {
            type: 'object',
            properties: {
              componentName: {

...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A flexible input component with validation states, icons, and accessibility features.'
      }
    }
  },
  tags: ['autodocs'],
...
export const WithIcons: Story = {
  ...
  play: async ({ canvasElement }) => {
    const canvas = within(canvasElement);
    const inputs = canvas.getAllByRole('textbox');
    const searchIcon = canvas.getByLabelText('Search').parentElement?.querySelector('svg');

...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A flexible card component for displaying content in a structured container.'
      }
    }
  },
  tags: ['autodocs'],
  ...
  args: {
    ...
    children: (
      <>
        ...
        <CardContent>
          <p>This card includes an image at the top. The image is responsive and maintains aspect ratio.</p>
        </CardContent>
        <CardFooter>
  ...
  args: {
    ...
    children: (
      <>
        ...
        <CardContent>
          <p>This card is interactive and can be clicked. It has focus states and hover effects.</p>
        </CardContent>
      </>
    )
  },
  ...
  args: {
    ...
    children: (
      <div className="p-4">
        ...
        <CardContent>
          <p>This card has no default padding, allowing for custom spacing control.</p>
        </CardContent>
      </div>
    )
  },
...
export const ProductCard: Story = {
  render: () => (
    ...
    >
      ...
      <CardContent>
        <p className="text-sm">High-quality sneakers with premium materials and comfort.</p>
  ...
  args: {
    ...
    children: (
      <>
        ...
        <CardContent>
          <p>This card demonstrates accessibility features including proper ARIA labels and keyboard navigation.</p>
        </CardContent>
      </>
    )
  },

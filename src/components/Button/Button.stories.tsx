...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: 'A versatile button component with multiple variants, sizes, and interactive states.'
      }
    }
  },
  tags: ['autodocs'],
...
export const WithIcons: Story = {
  render: () => (
    <div className="flex items-center gap-4">
      <Button
        leftIcon={<svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M10 5l-7 7h4v6h6v-6h4l-7-7z" /></svg>}
      >
        Upload
      </Button>
      <Button
        variant="outline"
        rightIcon={<svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M10 15l7-7H13V2H7v6H3l7 7z" /></svg>}
      >
        Download
      </Button>
    </div>

...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component:
          'A modal dialog component with accessibility features and customizable content.',
      },
    },
  },
  tags: ['autodocs'],
...
export const WithDescription: Story = {
  render: () => (
    ...
    >
      <p>
        Modal content goes here. The description provides additional context
        about what this modal is for.
      </p>
    </ModalWrapper>
  ),
  play: async ({ canvasElement }) => {
    ...
    const description = canvas.getByText(
      'This modal includes a description under the title'
    )
...
export const CloseOptions: Story = {
  render: () => (
    <div className="space-x-4">
      <ModalWrapper title="No Overlay Close" closeOnOverlay={false}>
...
export const Accessibility: Story = {
  render: () => (
    ...
    >
      <div className="space-y-4">
        <p>
          This modal includes proper ARIA attributes and keyboard navigation.
        </p>
